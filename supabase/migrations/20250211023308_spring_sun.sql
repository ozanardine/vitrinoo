...
DO $$
BEGIN
  DROP POLICY IF EXISTS "Store owners can manage their product attributes" ON product_attributes;
...
DO $$
BEGIN
  DROP POLICY IF EXISTS "Store owners can manage their product components" ON product_components;
  DROP POLICY IF EXISTS "Public can view product components" ON product_components;

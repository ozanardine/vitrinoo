...
CREATE POLICY IF NOT EXISTS "Store owners can manage their product attributes"
...
CREATE POLICY IF NOT EXISTS "Public can view product attributes"
  ON product_attributes
  FOR SELECT
  TO anon
  USING (true);
...
CREATE POLICY IF NOT EXISTS "Store owners can manage their product components"
...
CREATE POLICY IF NOT EXISTS "Public can view product components"
  ON product_components
  FOR SELECT
  TO anon
  USING (true);

/*
  ...
  This migration updates the price IDs to match the actual IDs in your Stripe account.
  
  1. Changes
    - Clear existing prices
    - Insert new prices with correct IDs from your Stripe account
    - Recreate index
*/
...
VALUES
  (
    'price_1Qr4qIQPROny1Uc1YbqPGgL9',  -- Free plan price
  ...
  (
    'price_1Qr4qIQPROny1Uc1r9MEWnpK',  -- Basic plan price
  ...
  (
    'price_1Qr4qIQPROny1Uc1DvYwG8Ks',  -- Plus plan price
